...
export function AcceptanceTest() {
  ...
  const fontHeading = { fontFamily: "'Lora', serif" }
  ...
  return (
    ...
    >
      <CardHeader
        ...
        style={{ backgroundColor: "#fbfaf6" }}
      >
        <div className="relative z-10 px-8 md:px-12 pt-10 md:pt-12 pb-5 md:pb-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                <span
                  ...
                  style={{ color: "#2f3d2a" }}
                >
                  Sección I · Estudio Sensorial
                </span>
              </div>
              <CardTitle
                className="text-4xl md:text-5xl leading-[1.05] tracking-tight"
                style={{ ...fontHeading, color: "#1f2a3d", fontWeight: 400 }}
              >
      ...
      <CardContent className="p-6">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <section className="pt-4 md:pt-5 pb-8 md:pb-10">
            <h3
              className="flex items-center justify-center gap-6 text-xs md:text-sm uppercase tracking-[0.3em] font-medium mb-10 before:content-[''] before:flex-1 before:h-[1px] before:bg-gradient-to-r before:from-transparent before:to-[#1f2a3d] after:content-[''] after:flex-1 after:h-[1px] after:bg-gradient-to-l after:from-transparent after:to-[#1f2a3d]"
              style={{ color: "#1f2a3d" }}
            >
              Guía de Evaluación
            </h3>
